<template>
    <div id="app">
        ...
        <font-awesome-icon icon="fa-solid fa-triangle-exclamation" class="fa-fade" />
        <font-awesome-icon icon="fa-solid fa-volleyball" class="fa-bounce" /> -->
        <router-link to="/dynamic/1">Contact</router-link>
        <h1>To-Do List</h1>
